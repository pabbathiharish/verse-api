...
export interface Env {
	...
	// ANDROID PROJECT1
	ANDROID_APPS_FIREBASE_PROJECT_ID: string
  	ANDROID_APPS_FIREBASE_CLIENT_EMAIL: string
	ANDROID_APPS_FIREBASE_PRIVATE_KEY: string;

	// ANDROID PROJECT2	
	ANDROID_APPS1_FIREBASE_PROJECT_ID: string
  	ANDROID_APPS1_FIREBASE_CLIENT_EMAIL: string
	ANDROID_APPS1_FIREBASE_PRIVATE_KEY: string;
